...
def main():
    ...
    if is_authenticated:
        ...
        <div class="teacher-info">
            ...
            <p><strong>Matières :</strong> {teacher_lesson}</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        with tab[0]:
            ...
            if not st.session_state.appel_started:
                ...
                with col1:
                    ...
                    enseignant = st.selectbox("👨‍🏫 Enseignant *",[user] + enseignants_df['Nom'].tolist() if not enseignants_df.empty else ["Enseignant Test"], key="enseignant_config")
                
                with col2:
                    # Liste des cours/matières
                    cours_list = [
                        "MATHEMATIQUES", "FRANCAIS", "CULTURE GENERALE", "ECONOMIE", "STATISTIQUES", 
                    ]
        ...
        with tab[1]:
            ...
            with st.form("form_seance"):
                ...
                with col2:
                    ...
                    centre_seance = st.selectbox("📍 Centre *", teacher_info['centres'])
                ...
                classe = st.multiselect("🎓 Classes/Niveau", options=CONCOURS_CHOICES)
        ...
        with tab[3]:
            ...
            with st.form("form_etudiant_teacher"):
                ...
                with col1:
                    ...
                    centre = st.selectbox("Centre *", teacher_info['centres'])
                    ...
                    if nom and prenom and sexe and concours1 and centre:
                        ...
                        if save_to_google_sheet("Étudiants", data):
                            ...
                            <div class="success-box">
                                ...
                                Enregistré par: <strong>{teacher_info['nom']}</strong>
                            </div>
                            """, unsafe_allow_html=True)
                            st.balloons()
                        else:
